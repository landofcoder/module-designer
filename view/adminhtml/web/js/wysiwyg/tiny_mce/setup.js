...
define([
    ...
    lofTinyMceWysiwygSetup.prototype = {
        ...
        // retrieve directilof URL with substituted directive value
        makeDirectiveUrl: function(directive) {
            return this.config.directilof_url.replace('directive', 'directive/___directive/' + directive);
        },

        encodeDirectilof: function(content) {
            // collect all HTML tags with attributes that contain directilof
        ...
        decodeDirectilof: function(content) {
            // escape special chars in directilof url to use it in regular expression
        ...
        beforeSetContent: function(o){
            if (this.config.add_widgets) {
                ...
                o.content = this.encodeDirectilof(o.content);
            } else if (this.config.add_directilof) {
                o.content = this.encodeDirectilof(o.content);
            }
        },
        ...
        saveContent: function(o) {
            if (this.config.add_widgets) {
                ...
                o.content = this.decodeDirectilof(o.content);
            } else if (this.config.add_directilof) {
                o.content = this.decodeDirectilof(o.content);
            }
            if(o.content!=''){
