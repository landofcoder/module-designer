 ...
 define([
    ...
    "mage/mage"
         ...
         */
         _create: function() {
            this._on({
                ...
                'click #lof_insert_files': 'insertSelectedFiles',
        ...
        _selectNode: function(event, data) {
            ...
            this.element.find('#delete_files, #insert_files, #lof_insert_files').toggleClass(this.options.hidden, true);
        ...
        selectFile: function(event) {
            ...
            this.element.find('#delete_files, #insert_files, #lof_insert_files')
        ...
        insert: function(event) {
            ...
            if (!targetEl.length) {
                LofMediabrowserUtility.closeDialog();
            ...
            return $.ajax({
                ...
                $('.loading-mask').hide();
                $('[role="dialog"]').show().addClass("lofpoupp");
                LofMediabrowserUtility.closeDialog();
                targetEl.focus();
            }, this));
        },
