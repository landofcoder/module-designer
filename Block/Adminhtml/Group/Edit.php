 ...
 */
namespace Lof\Designer\Block\Adminhtml\Group;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if($this->_isAllowedAction('Lof_Designer::group_save')){
    	...
    	if ($this->_isAllowedAction('Lof_Designer::grou_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('lof_designer')->getId()) {
            return __("Edit Group '%1'", $this->escapeHtml($this->_coreRegistry->registry('lof_designer')->getName()));
        } else {
            return __('New Group');
        }
    }
